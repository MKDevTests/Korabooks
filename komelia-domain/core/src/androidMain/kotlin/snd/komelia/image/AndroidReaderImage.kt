    ...
    override suspend fun getImageRegion(
        ...
        try {
            ...
            if (resized != null) {
                ...
                // resized == null means region was returned directly (the
                // zoom-in case). It is a VipsBackedImage there, so closing it is
                // safe — toReaderImageData() produced an independent copy.
